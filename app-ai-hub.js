    ...
    sheet.innerHTML = `
      <div id="aihCard" style="width:100%;max-width:560px;background:#fff;border-radius:20px 20px 0 0;max-height:92vh;overflow-y:auto;padding:18px 18px max(18px,env(safe-area-inset-bottom));">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
          ...
          <button id="aihClose" aria-label="닫기" style="margin-left:auto;background:none;border:none;font-size:22px;cursor:pointer;line-height:1;">×</button>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;">
          <button class="aih-card" data-act="dm" style="padding:16px 10px;border:2px solid #FEE500;border-radius:14px;background:linear-gradient(135deg,#FFF9C4,#FFF59D);cursor:pointer;text-align:left;">
            <div style="font-size:24px;margin-bottom:4px;">💬</div>
            <div style="font-size:13px;font-weight:800;color:#3F2C00;">DM 자동응답</div>
            <div style="font-size:10px;color:#3F2C0080;margin-top:2px;line-height:1.4;">인스타 DM 도착 → AI 자동 답장 (톤 카드 3종)</div>
          </button>
          <button class="aih-card" data-act="kakao" style="padding:16px 10px;border:2px solid #FFC107;border-radius:14px;background:linear-gradient(135deg,#FFFAEB,#FEF3C7);cursor:pointer;text-align:left;">
            <div style="font-size:24px;margin-bottom:4px;">📨</div>
