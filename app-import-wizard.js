...
(function () {
  ...
  function _showStep2() {
    ...
    document.getElementById('iw-back').addEventListener('click', _showStep1);
    document.getElementById('iw-next').addEventListener('click', _showPreview);
  }
  ...
  function open({ file, kind, onDone }) {
    state = { file, kind, analysis: null, mapping: {}, extras: {}, dup: { default: 'skip' }, onDone };
    _showStep1();
  }
